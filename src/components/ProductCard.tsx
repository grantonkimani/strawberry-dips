        ...
        <div className="relative overflow-hidden rounded-t-lg">
          {product.image_url ? (
            <div className="aspect-[3/4] bg-gray-100">
              ...
              />
              <div className="aspect-[3/4] bg-gradient-to-br from-pink-100 to-red-100 flex items-center justify-center hidden">
            ...
            <div className="aspect-[3/4] bg-gradient-to-br from-pink-100 to-red-100 flex items-center justify-center">
              <div className="text-center space-y-2">
                <div className="w-20 h-20 bg-gradient-to-br from-pink-200 to-red-200 rounded-full mx-auto flex items-center justify-center">
                  <span className="text-2xl">🍓</span>
                </div>
