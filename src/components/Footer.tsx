    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {/* Get in Touch */}
          <div>
            <h3 className="text-xl font-semibold mb-6 text-pink-400">Get in Touch</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-pink-400 flex-shrink-0" />
                <Link href="tel:0757567614" className="text-gray-200 hover:text-white transition-colors">
                  0757567614
                </Link>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-pink-400 flex-shrink-0" />
                <Link href="mailto:Strawberrydips.ke@gmail.com" className="text-gray-200 hover:text-white transition-colors">
          ...
          {/* Our Company */}
          <div>
            <h3 className="text-xl font-semibold mb-6 text-pink-400">Our Company</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/about#faq" className="text-gray-200 hover:text-white transition-colors">
                  Frequently Asked Questions (FAQs)
                </Link>
              </li>
              <li>
                <Link href="/about#care" className="text-gray-200 hover:text-white transition-colors">
                  Strawberry Care Guide
                </Link>
              </li>
              <li>
                <Link href="/about#story" className="text-gray-200 hover:text-white transition-colors">
                  Our Story
                </Link>
              </li>
              <li>
                <Link href="/contact#locations" className="text-gray-200 hover:text-white transition-colors">
                  Delivery Locations
                </Link>
              </li>
              <li>
                <Link href="/about#reviews" className="text-gray-200 hover:text-white transition-colors">
                  Customer Reviews
                </Link>
              </li>
              <li>
                <Link href="/about#careers" className="text-gray-200 hover:text-white transition-colors">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-6 text-pink-400">Account Info</h3>
            <ul className="space-y-3">
              <li>
              ...
              <li>
                <Link href="/account/orders" className="text-gray-200 hover:text-white transition-colors">
                  Order History
                </Link>
              </li>
              <li>
                <Link href="/policies/returns" className="text-gray-200 hover:text-white transition-colors">
                  Returns Policy
                </Link>
              </li>
              <li>
                <Link href="/policies/refund" className="text-gray-200 hover:text-white transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link href="/policies/delivery" className="text-gray-200 hover:text-white transition-colors">
                  Delivery Policy
                </Link>
              </li>
              <li>
                <Link href="/policies/privacy" className="text-gray-200 hover:text-white transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/policies/shipping" className="text-gray-200 hover:text-white transition-colors">
                  Shipping Zones
                </Link>
              </li>
              <li>
                <Link href="/policies/terms" className="text-gray-200 hover:text-white transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-gray-200 text-sm flex items-center justify-center md:justify-end">
