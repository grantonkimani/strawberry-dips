        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <Link href="tel:0757567614" className="text-gray-300 hover:text-white transition-colors">
                  0757567614
                </Link>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-pink-400 flex-shrink-0" />
                <Link href="mailto:Strawberrydips.ke@gmail.com" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/about#faq" className="text-gray-300 hover:text-white transition-colors">
                  Frequently Asked Questions (FAQs)
                </Link>
              </li>
              <li>
                <Link href="/about#care" className="text-gray-300 hover:text-white transition-colors">
                  Strawberry Care Guide
                </Link>
              </li>
              <li>
                <Link href="/about#story" className="text-gray-300 hover:text-white transition-colors">
                  Our Story
                </Link>
              </li>
              <li>
                <Link href="/contact#locations" className="text-gray-300 hover:text-white transition-colors">
                  Delivery Locations
                </Link>
              </li>
              <li>
                <Link href="/about#reviews" className="text-gray-300 hover:text-white transition-colors">
                  Customer Reviews
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/policies/delivery" className="text-gray-300 hover:text-white transition-colors">
                  Delivery Policy
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-gray-300 text-sm flex items-center justify-center md:justify-end">
