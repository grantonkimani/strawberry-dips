    ...
    <footer className="bg-gray-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold mb-3 text-pink-300">Contact Us</h3>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-pink-400" />
                <Link href="tel:0757567614" className="text-white hover:text-pink-300 transition-colors text-sm">
                  0757567614
                </Link>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-pink-400" />
                <Link href="mailto:Strawberrydips.ke@gmail.com" className="text-white hover:text-pink-300 transition-colors text-sm">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-white text-xs flex items-center justify-center md:justify-end">
              Made with <Heart className="h-3 w-3 text-red-500 mx-1" /> in Kenya
            </p>
            <p className="text-gray-400 text-xs mt-1">&copy; 2024 All rights reserved</p>
          </div>
        </div>
      </div>
    </footer>
