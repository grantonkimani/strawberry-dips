      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose max-w-none">
          <p className="text-gray-600 mb-6">
            At Strawberrydips, we stand behind the quality of our products. 
            This page outlines our refund policy for your peace of mind.
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Coming Soon</h2>
          <p className="text-gray-600">
            Our detailed refund policy is being finalized. Please contact us directly 
            ...
            0757567614</a> for any refund-related inquiries.
          </p>
        </div>
      </div>
      <Footer />
