  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-3xl font-bold mb-8 text-gray-900">Delivery Policy</h1>
        <div className="prose max-w-none">
          <p className="text-gray-600 mb-6">
            We offer fast and reliable delivery across Kenya. Same-day delivery available in Nairobi 
            and next-day delivery nationwide.
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Coming Soon</h2>
          <p className="text-gray-600">
            Our detailed delivery policy is being finalized. Please contact us directly 
            ...
            0757567614</a> for delivery inquiries.
          </p>
        </div>
      </div>
      <Footer />
